...
pub(super) fn make_shreds_from_data(
    ...
    if !unsigned_data.is_empty() || (shreds.is_empty() && !sign_last_fec_set) {
        ...
        shred_leftover_data(proof_size, chained, false, unsigned_data,
    ...
    if !signed_data.is_empty() || (shreds.is_empty() && sign_last_fec_set) {
        ...
        shred_leftover_data(proof_size, chained, true, signed_data,
...
#[allow(clippy::too_many_arguments)]
fn shred_leftover_data(proof_size: u8, chained: bool, resigned:bool, data: &[u8],
